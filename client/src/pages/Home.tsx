      ...
      <main className="flex-grow">
            ...
            <div className="flex flex-col justify-center p-6 md:p-8 lg:p-16 bg-[#F0F0F0] dark:bg-gray-900">
              ...
              <Reveal delay={0.4}>
                <p className="text-base md:text-xl font-mono mb-8 max-w-lg border-l-4 border-black pl-4 text-gray-800 dark:text-gray-300">
                  Notre réseau d'experts à Paris, Londres et New York transforme vos idées en réalité avec une exigence absolue.
                </p>
              </Reveal>
              <Reveal delay={0.6}>
        ...
        <div className="bg-[#CCFF00] border-b-4 border-black py-3 md:py-4 overflow-hidden whitespace-nowrap">
          <div className="animate-marquee inline-block">
            <span className="text-lg md:text-2xl font-bold uppercase mx-4 md:mx-8">DEVELOPPEMENT WEB</span>
            <span className="text-lg md:text-2xl font-bold uppercase mx-4 md:mx-8">•</span>
            <span className="text-lg md:text-2xl font-bold uppercase mx-4 md:mx-8">DESIGN UI/UX</span>
            <span className="text-lg md:text-2xl font-bold uppercase mx-4 md:mx-8">•</span>
            <span className="text-lg md:text-2xl font-bold uppercase mx-4 md:mx-8">STRATEGIE DIGITALE</span>
            <span className="text-lg md:text-2xl font-bold uppercase mx-4 md:mx-8">•</span>
            <span className="text-lg md:text-2xl font-bold uppercase mx-4 md:mx-8">SEO & MARKETING</span>
            <span className="text-lg md:text-2xl font-bold uppercase mx-4 md:mx-8">•</span>
             <span className="text-lg md:text-2xl font-bold uppercase mx-4 md:mx-8">DEVELOPPEMENT WEB</span>
            <span className="text-lg md:text-2xl font-bold uppercase mx-4 md:mx-8">•</span>
            <span className="text-lg md:text-2xl font-bold uppercase mx-4 md:mx-8">DESIGN UI/UX</span>
        ...
        <section className="py-20 container mx-auto px-4 dark:bg-gray-900">
          <Reveal width="100%">
            <h2 className="text-4xl md:text-6xl font-black uppercase mb-16 text-center">Nos Services</h2>
          </Reveal>
        ...
        <section className="bg-black text-white py-24 border-t-4 border-black dark:border-[#CCFF00]">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl md:text-6xl font-black uppercase mb-8">Prêt à transformer votre business ?</h2>
            <p className="text-xl font-mono mb-12 max-w-2xl mx-auto text-gray-300">
              Ne laissez pas votre entreprise stagner. Rejoignez l'élite digitale avec TechFlow.
            </p>
            <Link href="/contact">
